									...
									<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
										<div class="card-sigin">
											<div class="mb-5 d-flex">
												<a href="index.html"><img src="assets/img/media/pajntaub.jpg" class="sign-favicon-a ht-40" alt="logo">
												<img src="assets/img/brand/favicon-white.png" class="sign-favicon-b ht-40" alt="logo">
												</a>
												<h1 class="main-logo1 ms-1 me-0 my-auto tx-28">Store<span>Money</span></h1>
											</div>
											<div class="card-sigin">
												<div class="main-signup-header">
													<h2>ຍິນດີຕອນຮັບເຂົ້າສູ່ store money</h2>
													<h5 class="fw-semibold mb-4">ກະລຸນາເຂົ້າສູ່ລະບົບ.</h5>
														...
														<div class="form-group">
															<label>ລະຫັດ</label> <input class="form-control" placeholder="ປ້ອນລະຫັດ ຂອງທ່ານ" type="password" v-model="password">
													...
													<div class="main-signin-footer mt-5">
														<p><a href="">ລືມລະຫັດພ່ານ?</a></p>
														<p>ຍັງບໍ່ມີບັນຊີຜູ້ໃຊ້? <router-link to="/register">ລົງທະບ່ຽນໄໝ່</router-link></p>
													</div>
												</div>
											</div>
										</div>
